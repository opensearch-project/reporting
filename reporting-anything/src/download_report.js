...
parser.add_argument('--auth', {help: 'authentication type of the report; options are bas'});
...
await downloadVisualReport(parsed_args.url, format, width, height, filename, authType, username, password, sender, recipient);
